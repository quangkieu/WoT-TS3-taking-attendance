...
; Syntax ........: _TimeGetStamp()
; Parameters ....:
; Return values .: On Success - Returns Unix timestamp
...
; #FUNCTION# ====================================================================================================================
; Name ..........: _TimeMakeStamp
; Description ...: Create Unix timestamp from input values.
; Syntax ........: _TimeMakeStamp( [ second [, minute [, hour [, day [, month [, year [, isDST ]]]]]]] )
; Parameters ....: Second - Second for timestamp (0 - 59)
...
; Author ........: Rob Saunders (admin@therks.com)
; Modified ......:
; Remarks .......: The function will try and calculate dates for numbers outside of the
;					usual range.
...
; #FUNCTION# ====================================================================================================================
; Name ..........: _StringFormatTime
; Description ...: Get a string representation of a timestamp according to the format string given to the function.
; Syntax ........: _StringFormatTime($s_Format[, $i_Timestamp = -1[, $i_MaxLen = 255]])
; Parameters ....: $s_Format            - A format string to convert the timestamp to.
; 										See notes for some of the values that can be
; 										used in this string.
;                  $i_Timestamp         - A timestamp to format, possibly returned from_TimeMakeStamp. If left empty, default, or less
;									than 0, the current time is used. (default is -1)
;                  $i_MaxLen            - Maximum length of the string to be returned.
; 									Default is 255.
; Return values .: On Success - Returns string formatted timestamp.
;		   			On Failure - Returns False, sets @error = 99
; Author ........: Rob Saunders (admin@therks.com)
; Modified ......:
; Remarks .......: The date/time specifiers for the Format String:
